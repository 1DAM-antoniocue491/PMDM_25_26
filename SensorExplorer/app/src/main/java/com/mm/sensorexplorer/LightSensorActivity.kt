...
import com.mm.sensorexplorer.databinding.ActivityLightSensorBinding
...
class LightSensorActivity : AppCompatActivity(), SensorEventListener {
    ...
    private fun updateUI(lux: Float) {
        ...
        binding.rootLayout.setBackgroundColor(backgroundColor.toColorInt())
        binding.tvTitle.setTextColor(textColor.toColorInt())
        binding.tvLightValue.setTextColor(textColor.toColorInt())
        binding.tvLightStatus.setTextColor(textColor.toColorInt())
        binding.tvInfo.setTextColor(textColor.toColorInt())
    }
